...
<section id="contact" class="py-5 my-4">
    <div class="container">
        <div class="section-title">
            ...
            @elseif($committeesType == 2)
            <h2>BAFIITA Executive Committee MEMBER’S 2021-2023</h2>
            @else
        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/ec/Md. Anwarul Haque.jpg" class="img-fluid" alt=""
                            style="height: 100%">
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/past/Md.  Mahbubul  Alam.jpg" class="img-fluid" alt=""
                            style="height: 100%">
                    </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/past/Mrs. Momotaj Hossain Eaty.jpg" class="img-fluid"
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/past/Mrs. Sadia Afrine Munni.jpg" class="img-fluid" alt=""
                            style="height: 100%">
                    </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/past/Md. Alal Ahamed.jpg" class="img-fluid" alt=""
                            style="height: 100%">
                    </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/past/Mohammad Shah Akram.jpg" class="img-fluid" alt=""
                            style="height: 100%">
                    </div>
        ...
        <!-- 19-21-->
         <div class="section-title">
         <h2>BAFIITA Executive Committee MEMBER’S 2019-2021</h2>
            <img src="{{asset('public/images')}}/section-img.png" alt="#">
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    ...
                    <h5 class="mt-4">Md. Sayedul Haque Khan </h5>
                    <h6 class="text-danger">Organizing Secretary</h6>
                    <h6 class="text-danger">Rep : Khan Agro Feed Products</h6>
                </div>
            </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    ...
                    <h5 class="mt-4">Md. Abul Kalam Azad</h5>
                        <h6 class="text-danger">Joint Sectary General</h6>
                        <h6 class="text-danger">Rep: M/S. Al-Amin Poultry Feed</h6>
                </div>
            </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    ...
                    <h5 class="mt-4">Mr. Binod kumar sikaria</h5>
                        <h6 class="text-danger"> Treasurer</h6>
                        <h6 class="text-danger">Rep : jamuna trading corporation </h6>
                </div>
            </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    ...
                    <h5 class="mt-4">Mrs. Momotaj Hossain Eaty</h5>
                        <h6 class="text-danger">Social Welfare secretary </h6>
                        <h6 class="text-danger">Rep : M/s. Eaty Enterprise</h6>
                </div>
            </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/past/20192021/Mrs. Sadia Afrine Munni.jpg"
                            class="img-fluid" alt="" style="height: 100%">
                    </div>
                    <h5 class="mt-4">Mrs. Sadia Afrine Munni</h5>
                        <h6 class="text-danger">Press Secretary</h6>
                        <h6 class="text-danger">Rep : M/S. Synthia Enterprise</h6>
                </div>
            </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/past/20192021/Mr. Syed Kamalur Rahman.jpg"
                            class="img-fluid" alt="" style="height: 100%">
                    </div>
                    <h5 class="mt-4">Mr. Syed Kamalur Rahman</h5>
                        <h6 class="text-danger">Executive Member</h6>
                        <h6 class="text-danger">Rep : C.R Poultry and Fish Feed Ltd</h6>
                </div>
            </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    ...
                    <h5 class="mt-4">Md. Habibur Rahman</h5>
                        <h6 class="text-danger">Executive Member</h6>
                        <h6 class="text-danger">Rep : Al-Habib Enterprise</h6>
                </div>
            </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/past/20192021/md. shakhawat hossain.jpg" class="img-fluid"
                            alt="" style="height: 100%">
                    </div>
                    <h5 class="mt-4">Md. Shakhawat Hossain</h5>
                        <h6 class="text-danger">Executive Member</h6>
                        <h6 class="text-danger">Rep : Bio Care Agro Ltd</h6>
                </div>
            </div>
        </div>
        <!--19-21-->
        ...
        <!-- 17-19-->
         <div class="section-title">
         <h2>BAFIITA Executive Committee MEMBER’S 2017-2019</h2>
            <img src="{{asset('public/images')}}/section-img.png" alt="#">
        </div>
        <div class="row">
            <div class="col-lg-3 mb-3">
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/past/20172019//md. shahjahan miah.jpg" class="img-fluid"
                            alt="" style="height: 100%">
                    </div>
                    <h5 class="mt-4">Md. Shahjahan Miah</h5>
                    <h6 class="text-danger">Vice- President</h6>
                    <h6 class="text-danger"> Rep : Bismillah Feeds</h6>
                </div>
            </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/past/20172019/mr. kazi abu sayed.jpg" class="img-fluid"
                            alt="" style="height: 100%">
                    </div>
                    <h5 class="mt-4">Mr. Kazi Abu Sayed</h5>
                        <h6 class="text-danger">Executive Member</h6>
                        <h6 class="text-danger">Rep : Kazi Agro Limited</h6>
                </div>
            </div>
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    ...
                    <h5 class="mt-4">Md. Alal Ahamed</h5>
                        <h6 class="text-danger">Executive Member</h6>
                        <h6 class="text-danger">M/S. Alal Enterprise</h6>
                </div>
            </div>
        ...
        <!-- 14-17-->
         <div class="section-title">
         <h2>BAFIITA Executive Committee MEMBER’S 2014-2017</h2>
            <img src="{{asset('public/images')}}/section-img.png" alt="#">
        </div>
        <div class="row">
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    ...
                    <h5 class="mt-4">Sudhir Chowdhury</h5>
                    <h6 class="text-danger">Founder President</h6>
                    <h6 class="text-danger">Rep: M/S. Chowdhury Enterprise</h6>
                </div>
            </div>
            <div class="col-lg-3 mb-3">
            ...
            <div class="col-lg-3 mb-3">
                <div class="bg-white border text-center p-4">
                    <div>
                        <img src="{{asset('public/images')}}/past/20142017//Md. Sabir Hossain copy.jpg"
                            class="img-fluid" alt="" style="height: 100%">
                    </div>
                    <h5 class="mt-4">Md. Fazlul salam Mohsin</h5>
                    <h6 class="text-danger">Vice- President</h6>
                    <h6 class="text-danger"> Rep : M/S. Modina Poultry Feed</h6>
                </div>
            </div>
