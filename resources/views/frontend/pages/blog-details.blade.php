                        ...
                        <div class="col-12">
                            <div class="single-main">
                                ...
                                <div class="news-head" style="height: auto">
                                    <img src="{{asset('public')}}/{{$data->image_path}}" alt="#">
                                </div>
                                <!-- News Title -->
                                <h1 class="news-title"><a href="news-single.html">{{$data->title}}</a></h1>
                                <!-- Meta -->
                                <div class="meta">
                                    <div class="meta-left">
                                        <span class="author"><a href="#"><img src="{{asset('public/images')}}/blog/notice-1.png" alt="#">BAFIITA</a></span>
                                        <span class="date"><i class="fa fa-clock-o"></i>{{ $item->created_at->format('d F Y') }}</span>
                                    </div>
                                    <div class="meta-right">
                                        <span class="comments"><a href="#"><i class="fa fa-comments"></i>0 Comments</a></span>
                                        <span class="views"><i class="fa fa-eye"></i>1K Views</span>
                                    </div>
                                </div>
                                <!-- News Text -->
                                <div class="news-text">
                                    {!! $data->content !!}
                                    <a href="http://agrilife24.com/2021/2018-02-24-11-10-23/4064-bafita-29oct.html">Source by: http://agrilife24.com/2021/2018-02-24-11-10-23/4064-bafita-29oct.html</a>
                                </div><br>
